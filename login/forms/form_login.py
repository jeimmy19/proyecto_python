...
class App:
    ...
    def __init__(self):        
        self.ventana = tk.Tk()                             
        self.ventana.title('Inicio de sesion al Club Deportivo')
        self.ventana.geometry('800x500')
        self.ventana.config(bg='#82e0aa')
        ...
        label = tk.Label( frame_logo, image=logo,bg='#82e0aa' )
        ...
        title = tk.Label(frame_form_top, text="Inicio de sesion\n al Club Deportivo",font=('Times', 30), fg="#666a88",bg='#fcfcfc',pady=50)
